...
export const demoCustomers: CustomerRecord[] = [
  {
    ...
    phone: '(205) 555-0148',
    billing_address: addr('118 Meadowbrook Ln', 'Birmingham', 'AL', '35203'),
  ...
  },
  {
    ...
    phone: '(205) 555-0177',
    billing_address: addr('942 Willowcrest Dr', 'Hoover', 'AL', '35226'),
  ...
  },
  {
    ...
    phone: '(205) 555-0190',
    billing_address: addr('4400 Grovepoint Blvd', 'Vestavia Hills', 'AL', '35216'),
...
export const demoLeads: Lead[] = [
  {
    ...
    project_address: '77 Birchwood Ct, Mountain Brook, AL 35223',
  ...
  },
  {
    ...
    project_address: '215 Sagebrush Rd, Homewood, AL 35209',
    category: 'residential',
    service_type: 'patio',
    length_ft: 18,
    width_ft: 14,
...
export const demoJobs: Job[] = [
  {
    ...
    job_type: 'driveway',
    category: 'residential',
    address: addr('118 Meadowbrook Ln', 'Birmingham', 'AL', '35203'),
  ...
  },
  {
    ...
    job_type: 'patio',
    category: 'residential',
    address: addr('942 Willowcrest Dr', 'Hoover', 'AL', '35226'),
  ...
  },
  {
    ...
    job_type: 'commercial',
    category: 'commercial',
    address: addr('4400 Grovepoint Blvd', 'Vestavia Hills', 'AL', '35216'),
...
export const demoContractors: Contractor[] = [
  {
    ...
    phone: '(205) 555-0122',
    address: addr('300 Commerce St', 'Hoover', 'AL', '35226'),
    service_area: ['Birmingham', 'Hoover', 'Vestavia Hills', 'Homewood'],
  ...
  },
  {
    ...
    phone: '(205) 555-0166',
    address: addr('88 Foundry Rd', 'Trussville', 'AL', '35173'),
    service_area: ['Trussville', 'Homewood', 'Vestavia Hills'],
...
export const demoBidOpportunities: BidOpportunity[] = [
  {
    ...
    location: '4400 Grovepoint Blvd, Vestavia Hills, AL 35216',
