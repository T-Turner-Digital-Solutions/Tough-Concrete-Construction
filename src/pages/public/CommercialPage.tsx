    ...
    <div>
      ...
      <section className="container-page py-16 sm:py-24">
        ...
        <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4">
          {services.map((s) => {
            const override = COMMERCIAL_IMAGE_OVERRIDES[s.key];
            const image = override === null ? undefined : (override ?? SERVICE_IMAGES[s.key]);
            return <ServiceCard key={s.key} service={s} image={image} />;
          })}
        </div>
      </section>
