...
const GALLERY_ITEMS: GalleryItem[] = [
  { id: 'gal-1', tags: ['before', 'driveways'], badge: 'Before', caption: 'Cracked, heaving driveway before removal — Fairview, TX' },
  { id: 'gal-2', tags: ['during', 'driveways'], badge: 'During', caption: 'Forms and rebar set for a new driveway pour' },
  { id: 'gal-3', tags: ['after', 'driveways'], badge: 'After', caption: 'Broom-finished driveway, ready for traffic — McKinney, TX' },
  ...
  { id: 'gal-7', tags: ['after', 'patios', 'decorative'], badge: 'After', caption: 'Finished stamped patio, slate pattern — Allen, TX' },
  ...
  { id: 'gal-11', tags: ['after', 'commercial'], badge: 'After', caption: 'Completed commercial parking pad — Plano, TX' },
  ...
  { id: 'gal-15', tags: ['after', 'decorative'], badge: 'After', caption: 'Stamped stone-pattern pool deck — Prosper, TX' },
  ...
  { id: 'gal-18', tags: ['after', 'slabs'], badge: 'After', caption: 'Finished garage slab, troweled smooth — Wylie, TX' },
